...
def test_dipL_4_rip   (DUMP,THE_rip): DUMP.dump( UT.dipL_4_rip  (THE_rip) )
def test_pipLL_4_rip  (DUMP,THE_rip): DUMP.dump( UT.pipLL_4_rip (THE_rip) )
def test_pip2D_4_rip  (DUMP,THE_rip): DUMP.dump( UT.pip2D_4_rip (THE_rip) )
...
def test_mkfiles4ripT4base___regression(THE_rip, TEMP, DUMP):
    files = UT.mkfiles4ripT4base( THE_rip, TEMP/'foo')
